...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    int originalresult = result1;

    result1 = result1 - 1;
    System.out.println(originalresult + " - 1 = " + result1);
    originalresult = result1;

    result1 = result1 * 2;
    System.out.println(originalresult + " * 2 = " + result1);
    originalresult = result1;
    ...
    result1 = result1 + 8;
    System.out.println(originalresult + " + 8 = " + result1);
    originalresult = result1;

    result1 = result1 % 7;
    System.out.println(originalresult + " % 7 = " + result1);
